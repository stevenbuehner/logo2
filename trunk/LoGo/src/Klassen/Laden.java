...
public class Laden {
    ...
    public void LadeSpiel( ){
       ...
       int rueckgabe =  chooser.showOpenDialog((FensterSpieloberflaeche)LoGoApp.meineOberflaeche);

       if(rueckgabe == JFileChooser.CANCEL_OPTION)
       {
           JOptionPane.showMessageDialog(null, "Ladevorgang wurde abgebrochen!");
       }
       else
       {
            ...
            do
            {
                ...
                switch(this.getID(identifier)){
                    ...
                    case 8:
                        ...
                        s_parameter = (String) s_parameter.subSequence(0, 2);
                        l_parameter = Long.parseLong(s_parameter);
                ...
                //Letzte Zeichen Abfragen
                if( _geladenerString.equals(")"))
                {
                    _geladenerString = (String) _geladenerString.subSequence(0, 0);
                }
